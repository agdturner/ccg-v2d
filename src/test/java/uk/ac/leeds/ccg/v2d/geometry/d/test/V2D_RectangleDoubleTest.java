...
public class V2D_RectangleDoubleTest extends V2D_TestDouble {
    ...
    /**
     * Test of join method, of class V2D_RectangleDouble covered by
     * {@link #testGetIntersection_V2D_LineSegmentDouble_int()} and
     * {@link #testGetIntersection_V2D_Line_int()}.
     */
    @Test
    ...
    /**
     * Test of setOffset method, of class V2D_RectangleDouble.
     */
    @Test
    public void testSetOffset() {
        System.out.println("setOffset");
        // No test.
//        V2D_VectorDouble offset = P1P1P1;
//        V2D_RectangleDouble instance = new V2D_RectangleDouble(pP0P0P0, pP0P1P0, pP1P1P0, pP1P0P0);
//        instance.setOffset(offset);
//        V2D_RectangleDouble instance2 = new V2D_RectangleDouble(pP1P1P1, pP1P2P1, pP2P2P1, pP2P1P1);
//        assertEquals(instance, instance2);
    ...
    public void testGetIntersection_V2D_TriangleDouble_double() {
        ...
        // Test 2
         t = new V2D_TriangleDouble(pP2P2, new V2D_PointDouble(4d,4d), 
         ...
         expResult = new V2D_TriangleDouble(pP2P2, new V2D_PointDouble(4d,4d), 
                 new V2D_PointDouble(2d, 4d));
...
//         t = new V2D_TriangleDouble(pN1P0, pN1P2, pP1P0);
//         instance = new V2D_RectangleDouble(
//                 new V2D_PointDouble(0d,0d),
//                 new V2D_PointDouble(0d,6d),
//                 new V2D_PointDouble(6d,6d),
...
//                (V2D_TriangleDouble) result, epsilon));
//        // Test 4
//         t = new V2D_TriangleDouble(new V2D_PointDouble(4d,4d), new V2D_PointDouble(5d,5d), 
//                 new V2D_PointDouble(2d, 4d));
//         instance = new V2D_RectangleDouble(
//                 new V2D_PointDouble(0d,0d),
//                 new V2D_PointDouble(0d,6d),
...
//                epsilon, (V2D_LineSegmentDouble) result));
//        // Test 5
//         t = new V2D_TriangleDouble(new V2D_PointDouble(7d,7d), new V2D_PointDouble(8d,8d), 
//                 new V2D_PointDouble(2d, 4d));
//         instance = new V2D_RectangleDouble(
//                 new V2D_PointDouble(0d,0d),
//                 new V2D_PointDouble(0d,6d),
...
//        assertNull(result);
//        // Test 6
//         t = new V2D_TriangleDouble(new V2D_PointDouble(0d,1d,-1), new V2D_PointDouble(0d,5d), 
...
//                epsilon, (V2D_LineSegmentDouble) result));
//        // Test 7
//         t = new V2D_TriangleDouble(new V2D_PointDouble(0d,2d,-2d), new V2D_PointDouble(0d,5d,-2d), 
...
//                epsilon, (V2D_LineSegmentDouble) result));
//        // Test 8
//         t = new V2D_TriangleDouble(new V2D_PointDouble(0d,2d,-2000d), new V2D_PointDouble(0d,5d,-2000d), 
...
//                epsilon, (V2D_LineSegmentDouble) result));
//        // Test 9
//         t = new V2D_TriangleDouble(new V2D_PointDouble(0d,2d,-2000000d), new V2D_PointDouble(0d,5d,-2000000d), 
...
//                epsilon, (V2D_LineSegmentDouble) result));
//        // Test 10
//         t = new V2D_TriangleDouble(new V2D_PointDouble(0d,1d,-2d), new V2D_PointDouble(0d,5d,-2d), 
