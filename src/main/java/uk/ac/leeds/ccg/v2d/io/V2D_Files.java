 ...
 */
package uk.ac.leeds.ccg.v2d.io;

import java.io.IOException;
import java.nio.file.Paths;
import uk.ac.leeds.ccg.generic.io.Generic_Defaults;
import uk.ac.leeds.ccg.generic.io.Generic_Files;
import uk.ac.leeds.ccg.v2d.core.V2D_Strings;
 ...
 * @version 1.0.0
 */
public class V2D_Files extends Generic_Files {
     ...
     */
    public V2D_Files() throws IOException {
     ...
     * @throws IOException If encountered.
     */
    public V2D_Files(Generic_Defaults d) throws IOException {
        super(d);
    }
